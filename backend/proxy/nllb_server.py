...
def strip_markdown(text: str) -> str:
  ...
  """
  # CRITICAL: Remove broken LATEXINLINE/LATEXDISPLAY tokens generated by small models
  # These are NOT real LaTeX formulas - they're broken placeholders the model invents
  # Pattern matches: LATEXINLINE, LATEXINLINE26, LATEXDISPLAY_0, LATEXINLINE_27, etc.
  text = re.sub(r'\bLATEX(?:INLINE|DISPLAY)[_\d]*\b', '', text, flags=re.IGNORECASE)
  # Also remove __LATEX_INLINE_N__ and __LATEX_DISPLAY_N__ style tokens
  text = re.sub(r'__LATEX_(?:INLINE|DISPLAY)_\d+__', '', text, flags=re.IGNORECASE)
