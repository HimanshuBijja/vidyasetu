"""
vidyasetu model setup script for translation models.
...
from transformers import NllbTokenizerFast  # type: ignore
...
def setup_nllb() -> None:
  ...
  print()
  print("Setting up NLLB-200 for vidyasetu...")
...
def setup_models() -> None:
  ...
  print("=" * 60)
  print("vidyasetu Translation Model Setup (NLLB-200)")
  print("=" * 60)
  print()
  ...
  print()
  print("=" * 60)
  print("✅ vidyasetu model setup complete!")
  print("=" * 60)
  print()
  print("NLLB-200 is now cached and will run offline.")
  print("This is the only translation model used by vidyasetu.")
